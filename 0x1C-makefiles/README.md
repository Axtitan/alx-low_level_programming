...
Helper Files 🙌
school.c: C function that displays a seahorse in text. Used for Makefile practice purposes throughout project. Provided by ALX.

main.c: Main C function that runs the function defined in school.c. Provided by ALX

Header File 📁
m.h: Header file defining the function prototype used in school.c. Provided by ALX.
Tasks 📃
0. make -f 0-Makefile
